      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10 text-left">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            India’s leading event booking platform. Create unforgettable memories with us.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-4 text-gray-500 text-sm">
            <li className="flex items-start gap-3">
              ...
              <span>No 123, Event Plaza, <br/> Jaipur, India</span>
            </li>
        ...
        <div>
          ...
          <p className="text-gray-500 text-xs mb-4 italic">Join us to stay updated about the latest events..</p>
