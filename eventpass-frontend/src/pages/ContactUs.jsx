      ...
      <main className="ml-64 flex-grow relative flex flex-col min-h-screen">
        ...
        <div className="p-10 flex-grow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ContactCard icon={<Phone className="text-lime-400" size={32}/>} title="Call Us"    detail="+91 9999999999"    />
            <ContactCard icon={<Mail className="text-lime-400" size={32}/>}  title="Email"      detail="hello@eventpass.com"  />
            <ContactCard icon={<MapPin className="text-lime-400" size={32}/>} title="Location"  detail="India"  />
          </div>
        </div>
      </main>
    </div>
