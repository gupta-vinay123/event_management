...
const Report = () => {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            try {
                ...
                const { data } = await API.get('/bookings/admin/report');
                setBookings(data);
            } catch (err) {
    ...
    const generatePDF = () => {
        ...
        const doc = new jsPDF();
        doc.setFontSize(18);
        doc.text("EventPass - Sales Report", 14, 20);
        doc.setFontSize(11);
                                    ...
                                    <tr key={b._id} className="hover:bg-white/[0.03] transition-colors group">
                                        ...
                                        <td className="p-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {/* ✅ Fixed: ticketsBooked not tickets */}
                                                <span className="font-bold">{b.ticketsBooked || 0}</span>
                                            </div>
                                        </td>
                                        <td className="p-6">
